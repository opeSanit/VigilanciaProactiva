...
function exp_28042022VigProac_2rule0_eval_expression(context) {
    // "TIPO DE ESTABLECIMIENTO" = 'SERVICIOS SALUD'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'SERVICIOS SALUD');
    } else {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'SERVICIOS SALUD');
    }
}
...
function exp_28042022VigProac_2rule1_eval_expression(context) {
    // "TIPO DE ESTABLECIMIENTO" = 'ALIMENTOS'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'ALIMENTOS');
    } else {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'ALIMENTOS');
    }
}
...
function exp_28042022VigProac_2rule2_eval_expression(context) {
    // "TIPO DE ESTABLECIMIENTO" = 'SALUD AMBIENTAL'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'SALUD AMBIENTAL');
    } else {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'SALUD AMBIENTAL');
    }
}
...
function exp_28042022VigProac_2rule3_eval_expression(context) {
    // "TIPO DE ESTABLECIMIENTO" = 'INSUMOS SALUD'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'INSUMOS SALUD');
    } else {
        return (feature.get('TIPO DE ESTABLECIMIENTO')  == 'INSUMOS SALUD');
    }
}